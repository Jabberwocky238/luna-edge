...
func main() {
	...
	flag.BoolVar(&cfg.K8sBridgeEnabled, "k8s-bridge-enabled", envOr("LUNA_K8S_BRIDGE_ENABLED", "0") == "1", "enable kubernetes dns/ingress/gateway bridges on master")
	...
	flag.StringVar(&cfg.K8sIngressClass, "k8s-ingress-class", envOr("LUNA_K8S_INGRESS_CLASS", "luna-edge"), "kubernetes ingress class watched by master ingress bridge")
