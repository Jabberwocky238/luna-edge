...
// ServiceBindingRouteKind 表示 Kubernetes Gateway/Ingress 物化后的路由类别。
type ServiceBindingRouteKind string

const (
	ServiceBindingRouteKindHTTP           ServiceBindingRouteKind = "http"
	ServiceBindingRouteKindHTTPS          ServiceBindingRouteKind = "https"
	ServiceBindingRouteKindGRPC           ServiceBindingRouteKind = "grpc"
	ServiceBindingRouteKindTLSRoute       ServiceBindingRouteKind = "tls-route"
	ServiceBindingRouteKindTLSPassthrough ServiceBindingRouteKind = "tls-passthrough"
	ServiceBindingRouteKindTCP            ServiceBindingRouteKind = "tcp"
	ServiceBindingRouteKindUDP            ServiceBindingRouteKind = "udp"
)
...
type ServiceBinding struct {
	...
	// Namespace 是服务所属命名空间，兼容 ServiceBinding 风格来源。
